...
public class Hero extends Char {
	...
	public static final int STARTING_SKL = 5;
	public static final int STARTING_ARC = 0;
	...
	private static final String SKILL = "SKL";
	private static final String ARCANE = "ARC";
