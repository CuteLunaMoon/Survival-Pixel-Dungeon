...
public class ShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
		...
		case 1: 
			itemsToSpawn.add( (Random.Int( 2 ) == 0 ? new Crossbow().identify() : new Crossbow()).identify() );

			itemsToSpawn.add( new LeatherArmor().identify() );
			break;
			case 2:
			itemsToSpawn.add( new SandalsOfNature().identify());
			itemsToSpawn.add( new HornOfPlenty().identify());
			break;
		case 6: default:
	//	itemsToSpawn.add( new ScrollOfMagicalInfusion() );
	//	itemsToSpawn.add( new ScrollOfMagicalInfusion() );
	//	itemsToSpawn.add( new ScrollOfMagicalInfusion() );
	//	itemsToSpawn.add( new ScrollOfMagicalInfusion() );
	//	itemsToSpawn.add( new ScrollOfMagicalInfusion() );
